    ...
    <div class="container">
        ...
        <form @submit.prevent="save" class="needs-validation" novalidate>
            <div class="row">
                ...
                <div class="col-md-6">
                    <BsInputNumber v-model="config.voltage_config" unit="V" label="Voltage config" min="3" max="6"
                        step=".01" width="4"
                ...
                <div class="col-md-6">
                    <BsInputSwitch v-model="config.storage_sleep" label="Storage sleep"
                ...
                <div class="col-md-6">
                    <BsInputSwitch v-model="config.battery_saving" label="Battery saving"
                ...
                <div class="col-md-12">
                    <BsInputRadio v-model="config.tempsensor_resolution" :options="tempsensorResolutionOptions"
                        ...
                        :disabled="disableDs18b20"></BsInputRadio>
                </div>
                <div class="col-md-6">
            ...
            <div class="row gy-2">
                ...
                <div class="col-md-3">
                    <button @click="calibrate" type="button" class="btn btn-secondary" :disabled="global.disabled">
                        <span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"
                            :hidden="!global.disabled"></span>
                        &nbsp;Calibrate gyro&nbsp;<span v-if="badge.deviceGyroCalibratedBadge()"
                            class="badge text-bg-danger rounded-circle">1</span>
                    </button>
                </div>
                <div v-if="status.ispindel_config" class="col-md-3">
                    <button @click="ispindel" type="button" class="btn btn-secondary" :disabled="global.disabled">
                        <span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"
                            :hidden="!global.disabled"></span>
                        &nbsp;Import iSpindel config&nbsp;<span v-if="badge.deviceMigrateIspindelBadge()"
                            class="badge text-bg-danger rounded-circle">1</span>
                    </button>
                </div>
            </div>
...
const ispindel = () => {
    ...
    config.sendFilesystemRequest(data, (success, text) => {
        if (success) {
            ...
            global.messageSuccess = "Imported gyro calibration data and formula from old configuration. Please save!"
        }
