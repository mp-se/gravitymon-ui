    ...
    <div class="container">
        ...
        <form v-if="status.platform!=='esp8266' && status.platform!=='esp32s2'" @submit.prevent="save" class="needs-validation" novalidate>
            <div class="row">
                ...
                <div class="col-md-12">
                    <BsInputRadio v-model="config.ble_format" :options="bleFormatOptions" label="Bluetooth data format"
                        help="Select the type of bluetooth transmission used." :disabled="global.disabled32" />
                </div>
            </div>
            <div class="row gy-2">
                <div class="col-md-12">
                ...
                <div class="col-md-3">
                    <button type="submit" class="btn btn-primary w-2" :disabled="global.disabled32 || !global.configChanged">
