<template>
    <div class="container">
        ...
        <form @submit.prevent="save" class="needs-validation" novalidate>
            <div class="row">
                <div class="col-md-6">
                    <BsInputSwitch v-model="config.gravity_temp_adjustment" label="Temperature adjust gravity"
                ...
                <div class="col-md-6">
                    <BsInputNumber v-model="config.formula_calibration_temp" :unit="'°'+config.temp_format" label="Gravity calibration temp" min="0"
                        max="100" step=".01" width="4"
                        help="Calibration temperature, used in temperatur correction formula, default 20C/68F"
                        :disabled="calTempAdj || config.gyro_disabled"></BsInputNumber>
                </div>
                <div class="col-md-6">
                    <BsInputSwitch v-model="config.ignore_low_angles" label="Ignore low angles"
                        help="When active, angles below water will be ignored. Note! Angle must be defined under calibration, first field."
                        :disabled="global.disabled || config.gyro_disabled"></BsInputSwitch>
                </div>
                <div class="col-md-6">
                    <BsInputNumber v-model="config.gyro_read_count" label="Gyro reads" min="10" max="100" width="4"
                ...
                <div class="col-md-6">
                    <BsInputNumber v-model="config.gyro_moving_threashold" label="Gyro moving threashold" min="50"
                        max="1000" width="4"
