    ...
    <div class="container">
        ...
        <form @submit.prevent="saveSettings" class="needs-validation" novalidate>
            <div class="row">
                ...
                <div class="col-md-9">
                    <BsInputText v-model="config.ota_url" type="url" maxlength="80" label="OTA URL"
                ...
                <div class="col-md-3">
                    <BsDropdown label="Predefined ota" button="URL" :options="otaOptions" :callback="otaCallback"
                        :disabled="global.disabled" />
                </div>
